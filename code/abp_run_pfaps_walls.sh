...
{ 
time {
# tail -n +2 "$input_density" | xargs -P9 -n 3 ./abp_pfaps_walls.sh
# printf "$vars" | xargs -P$num -d ' ' -I{} ./abp_pfaps_walls.sh {}
# seq $start $space $ending | xargs -P$num -I{} ./abp_pfaps_walls.sh {}
